<?php if (isset($success) && $success): ?>
    ...
    <div class="form-group">
        ...
        <ul style="margin-left: 20px; margin-top: 15px; line-height: 1.8;">
            ...
            <li><strong>Security:</strong> For security reasons, consider removing or restricting access to this installer</li>
            <li><strong>Documentation:</strong> Check the documentation for configuration and customization options</li>
        </ul>
    </div>
    ...
    <div class="form-group">
        ...
        <div style="background: #f0fdf4; padding: 15px; border-radius: 8px; margin-top: 15px; border-left: 4px solid #16a34a;">
            <p><strong>Database Tables:</strong> <?php echo $config['migration_results']['applied']; ?> tables created successfully</p>
